...
.. _component_architecture_log_cpp:

Log C++ Component Architecture
==============================

.. document:: Log C++ Architecture
   :id: doc__log_cpp_architecture
   :status: draft
   :safety: ASIL_B
   :security: NO
...
.. comp:: Log C++
   ...
   :uses: logic_arc_int__log_cpp__recorder,logic_arc_int__baselibs__json
